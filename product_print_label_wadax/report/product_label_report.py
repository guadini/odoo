...
class ReportProductTemplateLabel_2_5x5(models.AbstractModel):
    _name = 'report.product_print_label_wadax.label_2_5x5'
...
class ReportProductTemplateLabel_2_5x5_Multiple(models.AbstractModel):
    _name = 'report.product_print_label_wadax.label_2_5x5_multiple'
    _description = 'Product Label Report'
    ...
    def _get_report_values(self, docids, data):
        ...
        # rows = 9
        # column = 3
        values['page_numbers'] = (values.get('page_numbers') - 1) // (9 * 3) + 1
        return values
